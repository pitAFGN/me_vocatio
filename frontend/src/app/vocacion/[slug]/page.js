...
export default async function VocationDetail({ params }) {
    ...
    if (!profession) {
        return (
            <main className="min-h-screen bg-slate-50 dark:bg-[#040613] flex flex-col items-center justify-center p-6 text-center text-slate-900 dark:text-white font-sans transition-colors duration-300">
    ...
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-[#040613] p-6 sm:p-8 pt-24 relative overflow-hidden font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300">
