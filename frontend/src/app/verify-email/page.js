...
function VerifyEmailContent() {
  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-slate-100 dark:bg-[#0f172a] relative overflow-hidden p-6 transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-md bg-white dark:bg-[#1e293b] p-10 sm:p-12 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 mx-4 text-center transition-colors duration-300">
        {status === "loading" && (
          <>
