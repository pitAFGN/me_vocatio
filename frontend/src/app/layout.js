    ...
    <html lang="es">
      <body className="antialiased bg-[#e5e7eb] font-sans">
        ...
        <nav className="fixed top-0 w-full z-50 px-10 py-3 flex justify-between items-center 
          ...
          {/* Lado Derecho: Botones Conectados */}
          <div className="flex gap-4 items-center">
            ...
            {/* AHORA APUNTA A /login con el modo signup */}
            <Link href="/login?mode=signup" className="bg-white text-[#1e293b] px-7 py-2.5 rounded-full text-[11px] font-black shadow-[0_4px_12px_rgba(125,211,252,0.3)] transition-all hover:scale-105 active:scale-95">
              REGISTRO
            </Link>

            {/* APUNTA A /login normal */}
