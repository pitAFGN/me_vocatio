...
export default async function VocacionesPorCategoria({ params }) {
  ...
  if (!group) {
    return (
      <main className="min-h-screen bg-slate-50 dark:bg-[#040613] flex flex-col items-center justify-center p-6 text-center text-slate-900 dark:text-white font-sans">
