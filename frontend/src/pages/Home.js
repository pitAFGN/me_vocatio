      ...
      */}
      ...
      <div className="z-10 flex flex-col items-center justify-center text-center max-w-4xl mx-auto space-y-6 mt-8 md:mt-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <button className="w-full sm:w-auto px-6 py-3.5 text-slate-200 text-sm font-medium flex items-center justify-center gap-1.5 hover:text-purple-300 transition-colors group">
            Ver metodología
            <ArrowUpRight className="w-4 h-4 text-purple-400 group-hover:text-purple-300 transition-colors" />
          </button>
        </div>
      </div>
